...
public final class AuthlibInjectorServerList extends ObservableSetting implements JsonSchemaSetting {
    /// The NTUST Drasl Yggdrasil API endpoint bundled into newly created server lists.
    public static final String LITTLE_SKIN_URL = "https://drasl.ntust.camp/authlib-injector/";
